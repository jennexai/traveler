...
if($_POST['npass']==$_POST['cpass']){
          ...
          $update= dbRowUpdate('tbl_user', $form_data, "WHERE u_id = '".$user."'",$con);
    ...
    z-index: 2;
        ...
        <div class="container">
            <div class="row">
                ...
                <?php  $query = $con->query("SELECT * FROM  `tbl_user` WHERE `u_id`='".$_SESSION['id']."'") or  die(mysqli_error($con));
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-5">
                            <form action="" method="POST" id="profile" name="profile ">
                                ...
                                <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
                                    ...
                                    <input class="form-control" value="<?php echo $data['fname'];?>" name="fname" type="text" />
                                </div>
                                <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
                                    <label>Last Name</label>
                                    <input class="form-control" value="<?php echo $data['lname'];?>" name="lname" type="text" />
                                </div>
                                ...
                                <div class="form-group form-group-icon-left"><i class="fa fa-phone input-icon"></i>
                                    ...
                                    <input class="form-control" value="<?php echo $data['mobile'];?>" name="phone" type="text" />
                                </div>
                        ...
                        <div class="col-md-4 col-md-offset-1">
                            ...
                            <form method="post" onsubmit="return checkPassto();" id="changepassword" name="changepassword">
