...
$query = $con->query("SELECT * FROM `admin` WHERE `email`='".$email."' AND `pass`='".$pass."' ") or die(mysqli_error($con));
                                ...
                                <div class="col-md-4">
                                    ...
                                    <form method="POST" id="adminlogin" name="adminlogin">
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                                            ...
                                            <input class="form-control" placeholder="e.g. johndoe@gmail.com" name="email" type="text" />
                                        </div>
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-lock input-icon input-icon-show"></i>
                                            <label>Password</label>
                                            <input class="form-control" type="password" name="pass" placeholder="my secret password" />
                                        </div>
