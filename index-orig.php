...
<head>
<title>TravelRove - by ANEXAS</title>
...
<div class="row">
<div class="col-md-3">
<a class="logo" href="index.html"> <h6 class="text-color">TravelRove<br>(Powered by ANEXAS )</h6>
...
<div class="top-user-area clearfix">
    <ul class="top-user-area-list list list-horizontal list-border">
        <li>
            <h5 class="text-color"> 24 X 7 Support </h5>
        </li>
        <li>
            <h5 class="text-color">+91-990-239-5740</h5>
        </li>
        <!--
        <li>
            <h5 class="text-color">services@travelrove.com </h5> 
        </li>
        -->
    </ul>
</div>
    ...
    <div class="search-tabs search-tabs-bg mt50">
        ...
        <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
                <li class="active"><a href="#tab-1" data-toggle="tab"><i class="fa fa-building-o"></i> <span >Flights</span></a>
                </li>
                <li><a href="#tab-2" data-toggle="tab"><i class="fa fa-plane"></i> <span >Hotels</span></a>
                </li>
                                ...
                                <div class="tab-pane fade in active" id="flight-search-1">
                                    ...
                                    <div class="input-daterange" data-date-format="M d, D">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group form-group-lg form-group-icon-left"><i class="fa fa-FPAcalendar input-icon input-icon-highlight"></i>
...
<div class="thumb">
    ...
    <div class="thumb-caption">
        ...
        <p class="thumb-desc">We guarantee you are getting the best price on the total amount (including taxes and fees) of flights/hotel only bookings paid for at the time of booking</p>
    </div>
</div>
</div>
<div class="col-md-4">
<div class="thumb">
    ...
    <div class="thumb-caption">
        ...
        <p class="thumb-desc">Every community has standards. We’ve created standards and expectations to help keep our community safe, and to help everyone on travel and host with more confidence</p>
    </div>
</div>
</div>
<div class="col-md-4">
<div class="thumb">
    ...
    <div class="thumb-caption">
        ...
        <p class="thumb-desc">Get Inspired to book best destinations with wonderful deals. All Destinations are customised accroding to traveller and have great deal of options</p>
    </div>
</div>
</div>
</div>
...
<header class="thumb-header">
    <a class="hover-img curved" href="#">
        <img src="img/800x600.jpeg" alt="Image Alternative text" title="Upper Lake in New York Central Park" /><i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
    </a>
</header>
<div class="thumb-caption">
    <h4 class="thumb-title">USA</h4>
    <p class="thumb-desc">The Central Park Lake, in conjunction with the Ramble, creates an essential part of the "Greensward" design plan created by Frederick Law Olmsted and Calvert Vaux when designing the initial features of what would become Central Park.</p>
</div>
</div>
</div>
<div class="col-md-3">
...
<header class="thumb-header">
    <a class="hover-img curved" href="#">
        <img src="img/800x600XGr.jpeg" alt="Image Alternative text" title="lack of blue depresses me" /><i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
    </a>
</header>
<div class="thumb-caption">
    <h4 class="thumb-title">Greece</h4>
    <p class="thumb-desc">Greece is strategically located at the crossroads of Europe, Asia, and Africa. Situated on the southern tip of the Balkan peninsula, it shares land borders with Albania to the northwest, the Republic of Macedonia and Bulgaria to the north, and Turkey to the northeast.  </p>
</div>
</div>
</div>
<div class="col-md-3">
...
<header class="thumb-header">
    <a class="hover-img curved" href="#">
        <img src="img/800x600XAs.jpeg" alt="Image Alternative text" title="people on the beach" /><i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
    </a>
</header>
<div class="thumb-caption">
    <h4 class="thumb-title">Australia</h4>
    <p class="thumb-desc">Australia is a country and continent surrounded by the Indian and Pacific oceans. Its major cities – Sydney, Brisbane, Melbourne, Perth, Adelaide – are coastal. Its capital, Canberra, is inland. The country is known for its Sydney Opera House, the Great Barrier Reef, a vast interior desert wilderness called the Outback, and unique animal species like kangaroos and duck-billed platypuses.</p>
</div>
</div>
</div>
<div class="col-md-3">
...
<header class="thumb-header">
    <a class="hover-img curved" href="#">
        <img src="img/800X600XM.jpeg" alt="Image Alternative text" title="the journey home" /><i class="fa fa-plus box-icon-white box-icon-border hover-icon-top-right round"></i>
    </a>
</header>
<div class="thumb-caption">
    <h4 class="thumb-title">Mauritius</h4>
    <p class="thumb-desc">Mauritius, an Indian Ocean island nation, is known for its beaches, lagoons and reefs. The mountainous interior includes Black River Gorges National Park, with rainforests, waterfalls, hiking trails and wildlife like the flying fox. Capital Port Louis has sites such as the Champs de Mars horse track, Eureka plantation house and 18th-century Sir Seewoosagur Ramgoolam Botanical Gardens.</p>
</div>
</div>
</div>
</div>
...
<li>
    <a class="fa fa-facebook box-icon-normal round animate-icon-bottom-to-top" href="https://www.facebook.com/travelrove"></a>
</li>
<li>
    <a class="fa fa-twitter box-icon-normal round animate-icon-bottom-to-top" href="https://twitter.com/TravelRove"></a>
</li>
<li>
    <a class="fa fa-google-plus box-icon-normal round animate-icon-bottom-to-top" href="#"></a>
</li>
<li>
    <a class="fa fa-linkedin box-icon-normal round animate-icon-bottom-to-top" href="https://www.linkedin.com/in/travel-rove-a0a578134"></a>
</li>
<li>
...
<h4 class="text-color">+91-990-239-5740</h4>
<h4><a href="#" class="text-color">services@travelrove.com</a></h4>
