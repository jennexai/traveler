...
$xmlObject = simplexml_load_file("response.xml") or die("Error: Cannot create object");
//print_r($xmlObject);
$arr = json_decode( json_encode($xmlObject) , 1);
//print_r($xmlObject);
//print_r($arr['TrackId']);//['FlightDetails'])
//print_r($arr['ItinearyDetails']['Items'][0]['FlightDetails']);
$array = $arr['ItinearyDetails']['Items'];
